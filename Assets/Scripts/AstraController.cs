...
[System.Serializable]
public class NewPointFrameEvent : UnityEvent<PointFrame> { }
...
public class AstraController : MonoBehaviour
{
    ...
    private Astra.StreamReader _readerPoint;
    ...
    private PointStream _pointStream; //used for mapping particles to correct world-coords
    ...
    private long _lastPointFrameIndex = -1;
    ...
    public NewPointFrameEvent NewPointFrameEvent = new NewPointFrameEvent();
    ...
    public Toggle TogglePoint = null;
    ...
    private void UpdateStreamStartStop()
    {
        ...
        _isPointOn = TogglePoint == null || TogglePoint.isOn;
