...
Shader "Sprites/Outline"
{
    Properties
    {
		...
		//_OutlineThickness ("OutlineThickness", Range(1,5)) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
				...
				//int localThickness = _OutlineThickness < 5 ? _OutlineThickness : 5;
				int localThickness =5;
                if (_Outline > 0 && c.a != 0) {
					for (int i =1; i <= localThickness; i++)
					{
